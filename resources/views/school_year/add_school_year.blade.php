...
@section('body')
    <div class="content">
        ...
        <div class="sub-page-header">
            <h3 class="content-header mt-2">Add School Year</h3>
            <div class="tab-status-container">
                <div id="course-info-tab" class="tab-one tab-status"></div>
            </div>
        </div>
        <!-- Add School Year Form -->
        <form action="{{route('create_school_year')}}" method="POST" class="sub-page-content multi-form">
            @csrf
            <div class="form-one">
                <div class="form-top-container">
                    ...
                    <div class="form-input">
                        <div class="input-group">
                            ...
                            <input type="text" class="input-text" name="school_year" required/>
                        </div>
                        <div class="input-group">
                            <label class="label-input">Start Date</label>
                            <input type="date" class="input-text" name="start_date" required/>
                        </div>
                        <div class="input-group">
                            <label class="label-input">End Date</label>
                            <input type="date" class="input-text" name="end_date" required/>
                        </div>
                    </div>
                </div>
