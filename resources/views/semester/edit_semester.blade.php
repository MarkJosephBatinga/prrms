...
@section('body')
    <div class="content">
        ...
        <form action="{{route('update_semester')}}" method="POST" class="sub-page-content multi-form">
            @csrf
            <input type="hidden" class="input-text" name="id" id="id" value="{{$semester->id}}"/>
            <div class="form-one">
                <div class="form-top-container">
                    ...
                    <div class="form-input">
                        <div class="input-group">
                            ...
                            <input type="text" class="input-text" name="semester" value="{{$semester->semester}}" required/>
                        </div>
                    </div>
                </div>
